...
- Google Maps icon + label added in footer: yes
- IndiaMART icon + label placeholder added in footer: yes
- Top Stainless Steel Pages changed to a compact multi-column mini-link grid: yes
- Footer remains global across generated pages after rebuild: yes

## Screenshots

- Desktop footer: `qa/screenshots/final-home-footer-desktop.png`
- Mobile footer: `qa/screenshots/final-home-footer-mobile.png`
