...
const blogPosts = [
  ["ss-304-vs-ss-316", "SS 304 vs SS 316: Which Grade Should Chennai Buyers Choose?", "Compare SS 304 and SS 316 for Chennai fabrication, kitchen equipment, coastal exposure and RFQ clarity."],
  ["jindal-ss-304-sheet-chennai-buyer-guide", "Jindal SS 304 Sheet in Chennai: What Buyers Should Check Before Ordering", "Buyer checklist for Jindal make SS 304 sheet enquiries, certificates, finish, size and Chennai delivery."],
  ["stainless-steel-sheet-finishes", "Stainless Steel Sheet Finishes: 2B, BA, Mirror, Matt, Hairline and PVC", "How to describe 2B, BA, mirror, matt, hairline, brush and PVC coated sheet requirements in an RFQ."],
  ["ss-304-sheet-price-chennai", "SS 304 Sheet Price in Chennai: What Affects the Rate?", "Price-intent guide explaining SS 304 sheet rate factors without publishing fake fixed prices."],
  ["ss-316-sheet-price-chennai", "SS 316 Sheet Price in Chennai: When Is 316 Worth It?", "Buyer guide for SS 316 sheet price factors, corrosion exposure and when 316 may be discussed."],
  ["stainless-steel-pipes-welded-vs-seamless", "Stainless Steel Welded Pipe vs Seamless Pipe", "Understand welded and seamless stainless steel pipe enquiries before asking for a quote."],
  ["polished-stainless-steel-pipes-for-railings-chennai", "Polished Stainless Steel Pipes for Railings in Chennai", "Checklist for polished stainless steel pipe enquiries for railings, interiors and visible fabrication work."],
  ...
  ["stainless-steel-material-test-certificate", "MTC and Mill Certificate for Stainless Steel Buyers", "Practical notes on certificate requests for stainless steel buyers."],
  ["stainless-steel-for-commercial-kitchens", "Stainless Steel for Commercial Kitchen Fabrication", "Material forms and finish notes for commercial kitchen equipment fabricators."],
  ...
  ["stainless-steel-suppliers-ambattur-buyer-checklist", "Stainless Steel Suppliers in Ambattur: Buyer Checklist", "Ambattur buyer checklist for stainless steel sheets, rods, bars, pipes and industrial RFQs."],
  ["stainless-steel-supply-to-sricity-and-tada", "Stainless Steel Supply to Sricity and Tada", "Supply guidance from Chennai for buyers in Sricity and Tada industrial belts."],
  ["ss-304-round-bar-and-rod-buying-guide", "SS 304 Round Bar and Rod Buying Guide", "Buying notes for SS 304 rods, round bars, machining requirements and certificate expectations."],
  ["astm-a240-astm-a312-stainless-steel-buyers", "ASTM A240 and ASTM A312: What Stainless Steel Buyers Should Know", "Buyer-friendly explanation of ASTM A240 sheets and plates and ASTM A312 pipe enquiries."],
